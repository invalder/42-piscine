...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/04 22:44:58 by nyangsua          #+#    #+#             */
/*   Updated: 2021/12/05 03:40:30 by nnakarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	*rule13horz(int col, int i, int *block, int *id_edge)
{
	...
	p_block = &block[0];
	if (id_edge[2] == 1 && id_edge[3] == 3)
	{
		if (col == 0)
			*(block + i) = 8;
		else if (col == 2 && if_2_exist(*(block + i)))
			*(block + i) = *(block + i) - 2;
...
int	*rule31horz(int col, int i, int *block, int *id_edge)
{
	...
	p_block = &block[0];
	if (id_edge[2] == 3 && id_edge[3] == 1)
	{
		if (col == 0 && if_3_exist(*(block + i)))
			*(block + i) = *(block + i) - 4;
		else if (col == 1 && if_2_exist(*(block + i)))
			*(block + i) = *(block + i) - 2;
		else if (col == 3)
			*(block + i) = 8;
	}
